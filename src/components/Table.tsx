...
export function Table() {
  ...
  return (
    <div className="mx-4 mt-2 rounded border border-stroke bg-white p-1 shadow-default border-strokedark bg-boxdark">
        ...
        <table className="w-full table-auto">
          ...
          <tbody>
            {response.map((row, key) => (
              <tr
                key={key}
                className="border-b border-double border-neutral-400"
              >
                ...
                <td className="text-center">
                  {renderBadge(row.hasDone, row.status)}
                </td>
                <td className="text-center">
